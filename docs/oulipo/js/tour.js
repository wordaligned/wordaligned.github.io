...
$(document).ready(function(){
    ...
    var pause = function() {
        ...
        $('#toggle').attr('title', 'Play').off('click').click(play).html('<img src="files/play_icon.png" />');
    }
    var play = function() {
        $('#toggle').attr('title', 'Pause').off('click').click(pause).html('<img src="files/pause_icon.png" />');
        k_move();
    }
    var reset = function() {
        pause();
